...
class PrivBayes(dpart):
    def __init__(self, bounds: dict = None, n_parents: int = 2, n_bins: int = 20, epsilon: dict = None, prediction_matrix="infer"):
        self.n_bins = n_bins
        super().__init__(
            epsilon=epsilon, prediction_matrix=prediction_matrix, n_parents=n_parents
        )
