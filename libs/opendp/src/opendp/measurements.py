...
def make_base_discrete_gaussian(
    ...
    [make_base_discrete_gaussian in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/measurements/fn.make_base_discrete_gaussian.html)
...
def make_base_discrete_laplace(
    ...
    [make_base_discrete_laplace in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/measurements/fn.make_base_discrete_laplace.html)
...
def make_base_discrete_laplace_cks20(
    ...
    [make_base_discrete_laplace_cks20 in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/measurements/fn.make_base_discrete_laplace_cks20.html)
...
def make_base_discrete_laplace_linear(
    ...
    [make_base_discrete_laplace_linear in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/measurements/fn.make_base_discrete_laplace_linear.html)
...
def make_base_gaussian(
    ...
    [make_base_gaussian in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/measurements/fn.make_base_gaussian.html)
...
def make_base_geometric(
    ...
    [make_base_geometric in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/measurements/fn.make_base_geometric.html)
...
def make_base_laplace(
    ...
    [make_base_laplace in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/measurements/fn.make_base_laplace.html)
...
def make_base_ptr(
    ...
    [make_base_ptr in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/measurements/fn.make_base_ptr.html)
...
def make_randomized_response(
    ...
    [make_randomized_response in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/measurements/fn.make_randomized_response.html)
...
def make_randomized_response_bool(
    ...
    [make_randomized_response_bool in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/measurements/fn.make_randomized_response_bool.html)
