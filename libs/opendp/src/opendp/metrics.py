...
def _metric_free(
    ...
    [_metric_free in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/metrics/fn._metric_free.html)
...
def absolute_distance(
    ...
    [absolute_distance in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/metrics/fn.absolute_distance.html)
...
def change_one_distance(
    ...
    [change_one_distance in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/metrics/fn.change_one_distance.html)
...
def discrete_distance(
    ...
    [discrete_distance in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/metrics/fn.discrete_distance.html)
...
def hamming_distance(
    ...
    [hamming_distance in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/metrics/fn.hamming_distance.html)
...
def insert_delete_distance(
    ...
    [insert_delete_distance in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/metrics/fn.insert_delete_distance.html)
...
def l1_distance(
    ...
    [l1_distance in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/metrics/fn.l1_distance.html)
...
def l2_distance(
    ...
    [l2_distance in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/metrics/fn.l2_distance.html)
...
def metric_debug(
    ...
    [metric_debug in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/metrics/fn.metric_debug.html)
...
def metric_distance_type(
    ...
    [metric_distance_type in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/metrics/fn.metric_distance_type.html)
...
def metric_type(
    ...
    [metric_type in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/metrics/fn.metric_type.html)
...
def symmetric_distance(
    ...
    [symmetric_distance in Rust documentation.](https://docs.rs/opendp/0.7.0/opendp/metrics/fn.symmetric_distance.html)
